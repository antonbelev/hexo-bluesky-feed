...
module.exports = async function(args) {
  ...
  console.log("DEBUG: Hexo locals as object:", this.locals.toObject());

  console.log("DEBUG: Hexo locals cache invalidated");
  ...
  // Sort posts by their date field descending using Moment's toDate() if available
  postsArray.sort((a, b) => {
